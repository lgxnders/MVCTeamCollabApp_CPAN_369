        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareToken = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    IsPublicLink = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectMemberships_GuestSessions_GuestSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMemberships_GuestSessionId",
                table: "ProjectMemberships",
                column: "GuestSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectMemberships_ProjectId_GuestSessionId",
                table: "ProjectMemberships",
                columns: new[] { "ProjectId", "GuestSessionId" },
                unique: true,
